...
export default function DeleteDiscount({open, onClose, customerId, onDelete}: Props) {
    ...
    const handleDelete = async () => {
        ...
        showSuccess('Töötaja edukalt kustutatud.')
        setLoading(false)
        onDelete()
        onClose()
    }
                ...
                >
                    ...
                    <div className="space-y-3">
                        <p className="text-zinc-300">
                            Oled sa kindel, et soovid selle töötaja kustutada?
                        </p>
                    </div>
